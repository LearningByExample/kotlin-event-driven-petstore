...
alter table categories owner to petuser;
...
alter table breeds owner to petuser;
...
alter table pets owner to petuser;
...
alter table vaccines owner to petuser;
...
alter table tags owner to petuser;
...
alter table pets_vaccines owner to petuser;
...
alter table pets_tags owner to petuser;
